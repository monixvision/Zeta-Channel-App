...
const CierrePopUp = ({ setpopupIsOpen }) => (
    ...
    <ul className="flex gap-6 justify-end rounded-t-xl bg-dark py-3 px-5" >
        <li className="flex items-center justify-center">
            <img src={minimizar} alt="Minimizar" className="w-4 h-4 opacity-60" />
        </li>
        <li className="flex items-center justify-center">
            <img src={reSize} alt="ReSize" className="w-4 h-4 opacity-60" />
        </li>
        <li className="flex items-center justify-center">
